...
const contacts = [
  {
    label: 'Email',
    display: 'jonathan.carroll05@outlook.com',
    href: 'mailto:jonathan.carroll05@outlook.com',
    icon: (
  ...
  {
    label: 'LinkedIn',
    display: 'linkedin.com/in/asperal03',
    href: 'https://www.linkedin.com/in/asperal03/',
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor">
    ...
    <section id="contact" className={styles.section}>
      <div className={styles.container}>
        ...
        <p className={styles.subtitle}>
          Open to DevOps, SRE, and infrastructure engineering roles.
          <br />
          References available upon request — Austin Sellers (Sr. DevSecOps), Christian Crill (Systems Engineer), Matthew Smith (SysAdmin).
        </p>
      ...
      <footer className={styles.footer}>
        <div className={styles.footerInner}>
          <span className={styles.footerMono}>
            jonathan@carroll:~$&nbsp;
            <span className={styles.footerAccent}>echo &quot;Built with React + Vite. Ready for Docker + K8s.&quot;</span>
          </span>
        </div>
      </footer>
    </section>
